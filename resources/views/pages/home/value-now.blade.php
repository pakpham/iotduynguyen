 ...
 <div class="card">
   <div class="card-body">
     <div class="stat-widget-five">
       ...
       <div class="stat-content">
         <div class="text-left dib">
           <div class="stat-text"><span  class="count" id="value-ss2-2">@if(isset($last_data[0]->ss2))
            {{$last_data[0]->ss2}}
          @endif</span></div>
          <div class="stat-heading">Cảm biến 2</div> 
        </div>
 ...
 <div class="card">
   <div class="card-body">
     <div class="stat-widget-five">
       ...
       <div class="stat-content">
         <div class="text-left dib"> 
           <div class="stat-text"><span class="count" id="value-ss3-2">@if(isset($last_data[0]->ss3))
            {{$last_data[0]->ss3}}
          @endif</span></div>
          <div class="stat-heading">Cảm biến 3</div>
        </div>
 ...
 <div class="card">
   <div class="card-body">
     <div class="stat-widget-five">
       ...
       <div class="stat-content">
         <div class="text-left dib"> 
           <div class="stat-text"><span class="count" id="value-ss4-2">@if(isset($last_data[0]->ss4))
            {{$last_data[0]->ss4}}
          @endif</span></div>
          <div class="stat-heading">Cảm biến 4</div>
        </div>
