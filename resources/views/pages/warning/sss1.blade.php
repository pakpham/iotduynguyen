            ...
            <div class="col-sm-4">
              <div class="form-group">
                <select class="form-control" id="warning-sign-ss1-1" name="warning-sign-ss1-1"  >
                  ...
                  <option <?php if(isset($sss1)) if($sss1[0]->ss1_sign == 0 )echo'selected';?>  value="0">Below threshold</option>
                </select>
              </div>                  
            </div>
          </div>
            ...
            <div class="col-sm-4">
              <div class="form-group">
                <select class="form-control" id="warning-sign-ss1-2" name="warning-sign-ss1-2">
                  <option value="1">Above threshold</option>
                  <option <?php if(isset($sss1)) if($sss1[0]->ss2_sign == 0 )echo'selected';?> value="0">Below threshold</option>
                </select>
              </div>                  
            </div>
          </div>
            ...
            <div class="col-sm-4">
              <div class="form-group">
                <select class="form-control" id="warning-sign-ss1-3" name="warning-sign-ss1-3">
                  <option value="1">Above threshold</option>
                  <option <?php if(isset($sss1)) if($sss1[0]->ss3_sign == 0 )echo'selected';?> value="0">Below threshold</option>
                </select>
              </div>                  
            </div>
          </div>
            ...
            <div class="col-sm-4">
              <div class="form-group">
                <select class="form-control" id="warning-sign-ss1-4" name="warning-sign-ss1-4">
                  <option value="1">Above threshold</option>
                  <option <?php if(isset($sss1)) if($sss1[0]->ss4_sign == 0 )echo'selected';?> value="0">Below threshold</option>
                </select>
              </div>                  
            </div>
          </div>
