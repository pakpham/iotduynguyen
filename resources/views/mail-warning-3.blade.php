    ...
    <div style="text-align: center; border: 3px; border-style: solid; ; border-radius: 30px">
        ...
        <div style="text-align: left;">
            ...
            <ul>
                ...
                <li>Sensor Value: 
                    <ul>
                        <li>Altitude: <span style="color: blue">{{$warning_value->ss1}} m</span>
                            @if($sensor_over->sensor_over_1 == 1)
                                <span style='color: red'>(WARNING)</span>
                            @endif
                        </li>
                        <li>Temperature: <span style="color: blue">{{$warning_value->ss2}} °C</span>
                        ...
                        <li>Air Pressure: <span style="color: blue">{{$warning_value->ss4}} Pa</span>
